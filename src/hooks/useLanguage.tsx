...
const translations = {
  ru: {
    ...
    'trainers.grammarQuiz': 'Grammar Quiz:',
    'trainers.grammarQuizDesc': 'Интерактивные упражнения по грамматике',
    'trainers.listeningActivities': 'Listening Activities:',
    'trainers.listeningActivitiesDesc': 'Упражнения на аудирование с интерактивными заданиями',
    'trainers.speakingPractice': 'Speaking Practice:',
    'trainers.speakingPracticeDesc': 'Ролевые игры и диалоги для развития речи',
  ...
  en: {
    ...
    'trainers.grammarQuiz': 'Grammar Quiz:',
    'trainers.grammarQuizDesc': 'Interactive grammar exercises',
    'trainers.listeningActivities': 'Listening Activities:',
    'trainers.listeningActivitiesDesc': 'Listening exercises with interactive tasks',
    'trainers.speakingPractice': 'Speaking Practice:',
    'trainers.speakingPracticeDesc': 'Role plays and dialogues for speech development',
