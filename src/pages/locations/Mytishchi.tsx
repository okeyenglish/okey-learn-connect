...
export default function LocationMytishchi() {
  ...
  const handleWhatsApp = () => {
    const message = "Здравствуйте! Интересует обучение в филиале Мытищи.";
    window.open(`https://wa.me/74997073535?text=${encodeURIComponent(message)}`, "_blank");
  };

  const handleBooking = (course: string, time: string) => {
    const message = `Здравствуйте! Хочу записаться на курс "${course}" в ${time} в филиале Мытищи.`;
    window.open(`https://wa.me/74997073535?text=${encodeURIComponent(message)}`, "_blank");
  };
  ...
  useEffect(() => {
    ...
    const demoData = [
      {"branch":"Мытищи","course":"Kids 4-6","level":"Beginner","days_mask":"Пн/Ср/Пт","time":"15:30–16:30","is_online":false,"vacancies":6},
      {"branch":"Мытищи","course":"Kids 7-9","level":"A1","days_mask":"Вт/Чт","time":"16:40–18:00","is_online":false,"vacancies":4},
      {"branch":"Мытищи","course":"Teens","level":"A2","days_mask":"Пн/Ср","time":"18:10–19:30","is_online":false,"vacancies":8},
      {"branch":"Мытищи","course":"Adults General","level":"B1","days_mask":"Вт/Чт","time":"19:40–21:00","is_online":false,"vacancies":2},
      {"branch":"Мытищи","course":"IELTS Prep","level":"B2","days_mask":"Сб","time":"11:00–13:30","is_online":false,"vacancies":0},
    ];
  ...
  useEffect(() => {
    let filtered = scheduleData.filter(item => item.branch === "Мытищи");
    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">Филиал Мытищи</h1>
          <p className="text-xl text-muted-foreground mb-2">ул. Борисовка, 16А</p>
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Актуальное расписание занятий в филиале Мытищи
            </p>
          </div>
          ...
          <Card className="card-elevated">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground">ул. Борисовка, 16А, Мытищи</p>
              </div>
              <div>
          ...
          <Card className="card-elevated">
            ...
            <CardContent>
              ...
              <div className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <p>• МЦД-1 Мытищи (15 мин пешком)</p>
                <p>• Автобус от м. Медведково</p>
                <p>🚌 Остановка "Борисовка" (автобусы 361, 335)</p>
              </div>
            </CardContent>
          </Card>
        </div>
