...
export default function LocationLyubertsy1() {
  ...
  const handleWhatsApp = () => {
    const message = "Здравствуйте! Интересует обучение в филиале Люберцы (3 Почтовое отделение).";
    window.open(`https://wa.me/74997073535?text=${encodeURIComponent(message)}`, "_blank");
  };

  const handleBooking = (course: string, time: string) => {
    const message = `Здравствуйте! Хочу записаться на курс "${course}" в ${time} в филиале Люберцы (3 Почтовое отделение).`;
    window.open(`https://wa.me/74997073535?text=${encodeURIComponent(message)}`, "_blank");
  };
    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground mb-2">3 Почтовое отделение, 65к1</p>
          ...
          <Card className="card-elevated">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground">3 Почтовое отделение, 65к1, Люберцы</p>
              </div>
              <div>
          ...
          <Card className="card-elevated">
            ...
            <CardContent>
              ...
              <div className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <p>• Люберцы (МЦД-1, 10 мин пешком)</p>
                <p>• Лухмановская (10 мин на автобусе)</p>
                <p>🚌 Остановка "3 Почтовое отделение" (автобусы 525, 553)</p>
              </div>
            </CardContent>
          </Card>
        </div>
