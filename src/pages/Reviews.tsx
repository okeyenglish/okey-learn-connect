...
const studentReviews = [
  ...
  },
  {
    ...
    course: "Prepare (A2-B1)",
    rating: 5,
    text: "Отличная программа Prepare! За год обучения значительно улучшил свой уровень английского. Методика Cambridge очень эффективная, особенно нравится практическая направленность курса.",
    branch: "Мытищи",
    date: "Февраль 2024"
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    text: "Готовился к ЕГЭ по английскому. Результат - 92 балла! Методика подготовки очень эффективная, разбирали все типы заданий, много практики. Поступил в МГУ!",
    branch: "Стахановская", 
    date: "Июнь 2023"
  }
];
