...
export const useCRMState = () => {
  ...
  const [activeClientInfo, setActiveClientInfo] = useState<{ name: string; phone: string; comment: string; telegram_user_id?: string | number | null; max_chat_id?: string | null; has_pending_payment?: boolean } | null>(null);
