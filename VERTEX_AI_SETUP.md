...
Когда потребуется прямое подключение к Vertex AI (для контроля расходов, приватности данных, или увеличения лимитов), следуйте этой инструкции:
...
### Шаг 3: Переключение провайдера

Чтобы переключиться на Vertex AI, нужно установить environment переменную:
