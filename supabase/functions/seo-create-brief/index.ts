...
serve(async (req) => {
  ...
  try {
    ...
    console.log('[seo-create-brief] Calling Lovable AI...');
    ...
    if (!response.ok) {
      ...
      console.error('[seo-create-brief] Lovable AI error:', errorText);
    ...
    console.log('[seo-create-brief] Lovable AI response received');
