...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Getting WhatsApp contact info for: ${targetChatId}`);

    // Call Green API getContactInfo
    const infoUrl = `${apiUrl}/waInstance${instanceId}/getContactInfo/${apiToken}`;
    ...
    console.error('Error in whatsapp-get-contact-info:', error);
    return new Response(
