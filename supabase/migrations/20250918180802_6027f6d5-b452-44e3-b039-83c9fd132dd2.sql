...
DROP POLICY IF EXISTS "docs_read_all" ON public.docs;
DROP POLICY IF EXISTS "docs_service_manage" ON public.docs;

-- Allow public read access
CREATE POLICY "docs_read_all" ON public.docs FOR SELECT USING (true);

-- Allow service role to manage docs
CREATE POLICY "docs_service_manage" ON public.docs FOR ALL USING (true);