-- Сначала удаляем старую функцию, затем создаем расширенную
DROP FUNCTION IF EXISTS public.get_chat_threads_optimized(INT);

-- Создаем расширенную RPC с branch и аватарами
