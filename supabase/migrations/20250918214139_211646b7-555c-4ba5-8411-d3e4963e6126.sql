...
-- Phase 2: Database Hardening - Move extensions to dedicated schema
-- Create extensions schema if it doesn't exist
CREATE SCHEMA IF NOT EXISTS extensions;

-- Note: pgvector and pgcrypto are already installed system-wide
-- We'll keep them as they are since moving them requires superuser privileges
