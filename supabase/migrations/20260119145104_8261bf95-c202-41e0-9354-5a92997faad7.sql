-- Оптимизированная RPC-функция для загрузки семейных данных одним запросом
...
CREATE INDEX IF NOT EXISTS idx_lesson_sessions_group_date_scheduled 
