-- Drop and recreate the function with proper security and organization filtering
...
DECLARE
  v_org_id UUID;
BEGIN
  -- Get user's organization for multi-tenancy filtering
...
GRANT EXECUTE ON FUNCTION get_chat_threads_fast(INT) TO authenticated;
GRANT EXECUTE ON FUNCTION get_chat_threads_fast(INT) TO anon;